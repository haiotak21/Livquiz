          ...
          return (
            <div key={index}>
              <motion.div
                ...
                className={`relative p-6 2xl:p-4 ${index === 1 && "bg-pink-100"} ${index === 0 && "bg-indigo-100/80"} ${
                  index === 2 && "bg-orange-100"
                } rounded-xl h-[108%] md:h-[90%] lg:h-[108%] 2xl:w-[20vw] lg:w-[92%] lg:mx-auto gap-x-0 md:m-0 lg:m-0 md:w-[100%] md:gap-x-4 lg:-right-5 2xl:m-0`}
              >
                <Image
                  ...
                  width={200}
                  height={200}
                  className={`mx-auto w-[70%] ${index === 1 && "mt-[-20px] w-[85%]"} ${
                    index === 2 && "w-[450%] mt-[80px] md:mt-[10px] md:w-[100%]"
                  }`}
                />
