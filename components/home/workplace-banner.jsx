...
export default function WorkplaceBanner() {
  return (
    <section className="relative container max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center px-2 py-8 md:p-1 md:my-5 md:px-2 lg:px-0">
      ...
      <motion.div
        ...
        className="lg:block absolute left-24 -top-8 hidden 2xl:-top-8"
      >
        <Image src="/images/workplace-arrow.png" alt="workplace-arrow" width={200} height={100} />
      </motion.div>
      ...
      >
        <Image
          src="/images/workplace-image.png"
          alt="workplace-image"
          width={600}
          height={384}
