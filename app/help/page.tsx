...
const categories = [
  {
    ...
    description: "Learn the basics of LivQuiz",
    articles: 12,
  },
  {
    icon: Video,
  ...
  },
  {
    icon: MessageCircle,
    title: "Live Sessions",
    description: "Host and manage live quiz sessions",
    articles: 6,
  },
  {
    icon: FileText,
          ...
          <div className="container max-w-7xl mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                Find answers to your questions and learn how to get the most out of LivQuiz.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-purple-600 font-semibold">{category.articles} articles</p>
                </div>
              ))}
            </div>
