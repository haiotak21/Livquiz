                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
                                    {t('heroTitle', { default: 'All-in-One Quiz Platform for Engaging Learning' })}
                                </h1>
                                <p className="text-lg lg:text-xl text-gray-700 mb-8 leading-relaxed">
                                    {t('heroDescription', { default: 'Create, host, and analyze interactive quizzes for classrooms, training, and events.' })}
                                </p>
                        ...
                        >
                            <div className="flex items-center justify-center mb-6">
                                ...
                                <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900">
                                    {t('creationTitle', { default: 'Quiz Creation & Content Management' })}
                                </h2>
                            </div>
                    ...
                    <div className="container max-w-7xl mx-auto px-4 lg:px-6">
                        ...
                        >
                            <div className="flex items-center justify-center mb-6">
                                ...
                                <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900">
                                    {t('instructorTitle', { default: 'Advanced Instructor Control' })}
                                </h2>
                            </div>
                            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
                        ...
                        <div className="space-y-16">
                            {multiplayerFeatures.map((feature, index) => (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch ${index % 2 === 1 ? "lg:grid-flow-col-dense" : ""
                                        }`}
                                >
                                    {/* Text content side */}
                                    <div className={`${index % 2 === 1 ? "lg:col-start-2" : ""} flex flex-col h-full`}>
                                        <div className="flex flex-col h-full justify-center">
                                            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                                                {t(feature.titleKey, { default: 'Live Multiplayer Quiz Games' })}
                                            </h3>
                            ...
                            {analyticsFeatures.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <div className={`${index % 2 === 1 ? "lg:col-start-2" : ""} flex flex-col h-full`}>
                                        <div className="flex flex-col h-full justify-center">
                                            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                                                {t(feature.titleKey, { default: 'Track Student Progress' })}
                                            </h3>
                                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">{t(feature.descriptionKey)}</p>
                                            <ul className="space-y-3">
                                                {feature.featuresKeys.map((item, itemIndex) => (
                            ...
                            {aifeature.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <div className={`${index % 2 === 1 ? "lg:col-start-2" : ""} flex flex-col h-full`}>
                                        <div className="flex flex-col h-full justify-center">
                                            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                                                {t(feature.titleKey, { default: 'AI-Powered Features' })}
                                            </h3>
                                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">{t(feature.descriptionKey)}</p>
                                            <ul className="space-y-3">
                                                {feature.featuresKeys.map((item, itemIndex) => (
                            ...
                            {securityFeatures.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <div className={`${index % 2 === 1 ? "lg:col-start-2" : ""} flex flex-col h-full`}>
                                        <div className="flex flex-col h-full justify-center">
                                            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                                                {t(feature.titleKey, { default: 'Security & Exam Integrity' })}
                                            </h3>
                                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">{t(feature.descriptionKey)}</p>
                                            <ul className="space-y-3">
                                                {feature.featuresKeys.map((item, itemIndex) => (
                    ...
                    <div className="container max-w-7xl mx-auto px-4 lg:px-6 text-center">
                        ...
                        >
                            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6">
                                {t('ctaTitle', { default: 'Ready to get started?' })}
                            </h2>
                            <p className="text-lg lg:text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
                                {t('ctaDescription', { default: 'Sign up for free and start creating engaging quizzes today.' })}
                            </p>
                        </motion.div>
                    </div>
                </section>
