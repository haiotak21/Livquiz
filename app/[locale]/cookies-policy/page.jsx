                ...
                >
                    ...
                    <section className="mb-12">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
                            {(t.raw('howWeUseCookiesList', { default: [] }) || []).map((item, idx) => <li key={idx}>{item}</li>)}
                        </ul>
                    </section>
                    ...
                    <section className="mb-12">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
                            {(t.raw('manageCookiesLinks', { default: [] }) || []).map((item, idx) => <li key={idx}><Link href={item.url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">{item.label}</Link></li>)}
                        </ul>
                    </section>
